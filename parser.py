...
#         print("Raw response from LangChain:", response_content)

#         # Extract the JSON portion of the response
#         try:
#             json_start = response_content.find("{")  # Find where JSON begins
#             json_end = response_content.rfind("}")  # Find where JSON ends
...
#     # Concatenate with existing data, ensuring no duplicate rows (by 'file_name' as unique key)
...
#     # Specify the folder ID containing Excel files
